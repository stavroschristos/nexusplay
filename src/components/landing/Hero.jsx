    ...
    <section className="relative min-h-[100svh] flex items-center justify-center px-4 pt-24 pb-16 overflow-hidden">
      ...
      <div className="relative text-center max-w-3xl mx-auto">
        <motion.div initial={{ opacity: 0, y: 12 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.5 }}
          ...
          <Sparkles className="w-3.5 h-3.5" /> The home for every gamer
        </motion.div>
        ...
        <motion.h1 initial={{ opacity: 0, y: 16 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.6, delay: 0.05 }}
          ...
          Your Entire Gaming Life.<br /><span className="text-gradient bg-gradient-to-r from-violet-400 via-fuchsia-400 to-cyan-400 bg-clip-text text-transparent">One Profile.</span>
        </motion.h1>

        <motion.p initial={{ opacity: 0, y: 16 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.6, delay: 0.15 }}
          className="mt-6 text-lg text-muted-foreground max-w-xl mx-auto leading-relaxed">
          Connect your gaming accounts, showcase your achievements, discover new friends, join communities, and keep your entire gaming identity in one place.
        </motion.p>
